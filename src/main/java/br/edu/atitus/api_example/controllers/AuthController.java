...
import br.edu.atitus.api_example.dtos.SingninDTO;
...
public class AuthController {
	...
	@PostMapping("/signin")
	public ResponseEntity<String> signin( @RequestBody SingninDTO dto) throws AuthenticationException, Exception {
